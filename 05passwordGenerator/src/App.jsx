...
function App() {
  ...
  const passwordGenerator = useCallback(() => {
    ...
    setPassword(pass)
  }, [length, numbersAllowed, specialCharacterAllowed, setPassword])
  ...
  useEffect(() => {
    passwordGenerator()
  }, [length, numbersAllowed, specialCharacterAllowed, passwordGenerator])
      ...
      <div className='w-full max-w-xl mx-auto shadow-md rounded-lg px-4 py-3 my-8 text-orange-500 bg-gray-800'>
        ...
        <div className='flex shadow rounded-lg overflow-hidden mb-4'>
          <input
            ...
            ref={passwordRef}
          />
          <button onClick={copyPasswordToClipboard} className='outline-none bg-blue-700 text-white px-3 py-0.5 shrink-0 hover:bg-blue-600 active:bg-blue-800 active:scale-95 transition-all duration-9 cursor-pointer'>Copy</button>
        </div>
